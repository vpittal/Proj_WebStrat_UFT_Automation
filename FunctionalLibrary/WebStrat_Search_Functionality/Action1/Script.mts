'===================================================================
'            WebStrat Search functionality Automation
'===================================================================

On Error Resume Next

Call WT_Login()
 @@ hightlight id_;_Browser("Web.Strat").Page("Web.Strat").Frame("OutPatIFrameFoot").WbfGrid("Table1")_;_script infofile_;_ZIP::ssf2.xml_;_
...
'====================================================================
'wait 4
'Browser("name:=Web.Strat").page("title:=Web.Strat").WbfTabStrip("html id:=TabStrip1","html tag:=TabStrip","x:=2").Select "Search"
'Browser("name:=Web.Strat").page("title:=Web.Strat").WbfTabStrip("html id:=TabStrip1","html tag:=TabStrip","x:=2").Click
...
'
''Browser("name:=Web.Strat").Page("title:=Web.Strat").Frame("name:=DemographicsIFrame").WebEdit("name:=TextBoxUB1","html tag:=INPUT").Set "17"
'
''Value Codes
'
''Browser("name:=Web.Strat").Page("title:=Web.Strat").Frame("name:=DemographicsIFrame").WebCheckBox("html id:=checkValueCodes","type:=checkbox").Click
''
''Browser("name:=Web.Strat").Page("title:=Web.Strat").Frame("name:=DemographicsIFrame").WebEdit("name:=WebEdit","html id:=VC_0","html tag:=INPUT").Set "A8"
''
''Browser("name:=Web.Strat").Page("title:=Web.Strat").Frame("name:=DemographicsIFrame").WebEdit("name:=WebEdit","html id:=VC_0","html tag:=INPUT").PressKey "ENTER",micAlt
''
''
''
''
''Browser("name:=Web.Strat").Page("title:=Web.Strat").Frame("name:=DemographicsIFrame").WebEdit("name:=WebEdit","html id:=VC_Amount_0","html tag:=INPUT").Set "48"
''
''-----------------------------------------------------------------------------------------------
'
''Summary Screen
...
'
''Browser("name:=Web.Strat").Page("title:=Web.Strat").Frame("name:=InPatIFrameL").WebEdit("name:=dx1","html tag:=INPUT").Set " "
''Browser("name:=Web.Strat").Page("title:=Web.Strat").Frame("name:=InPatIFrameL").WebEdit("name:=Onset1","html tag:=INPUT").Set " "
''
'
''Line1
...
'
''----------------------------------------------------------------------------
''Capture the Total Proce,Status code,Return code and APC 
''=================================
...
'      End If
'    
'    Datatable.Export "C:\Proj_WebStrat_UFT_Automation\TestResults\WebStratSearchData6.xlsx"
''   End If
'''	
''Next
''
...
'==========================
'  Wait 10
'  Browser("name:=Web.Strat").page("title:=Web.Strat").Link("text:=File","html tag:=A").Click
'  ' Browser("name:=Web.Strat").Page("title:=Web.Strat").Link("name:=New (Alt+N)","visible:=False").Click
'   Browser("name:=Web.Strat").Page("Web.Strat").Link("New (Alt+N)").Click
'   Browser("Web.Strat").Dialog("VBScript").WinButton("No").Click
'   'Browser("Web.Strat").Dialog("#32770").WinButton("No").Click
'   
'   Wait 5
'   
'   'Browser("opentitle:=Web.Strat Login").page("title:=Web.Strat").Link("New (Alt+N)").Click
''    'Browser("opentitle:=Web.Strat Login").page("title:=Web.Strat").Link("name:=Delete").Click
''    'Browser("Web.Strat").Dialog("Message from webpage").WinButton("OK").Click
'    'Browser("name:=Web.Strat").Dialog("VBScript").WinButton("No").Click
'
'---------------------------------------------------------------------------------------
